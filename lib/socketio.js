...
io.on("connection", (socket) => {
	...
	socket.on("stop", require("../handlers/stop")(socket));
	socket.on("update satoshi", require("../handlers/update-satoshi")(socket));
	socket.on("timeout", require("../handlers/timeout")(socket));
